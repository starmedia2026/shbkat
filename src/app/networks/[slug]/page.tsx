    ...
    const handlePurchase = async () => {
        ...
        try {
            ...
            const purchasedCardNumber = await runTransaction(firestore, async (transaction) => {
                ...
                transaction.set(doc(collection(firestore, `customers/${user.uid}/notifications`)), { ...baseNotifData, type: 'purchase', title: 'شراء كرت', body: `تم شراء كرت (${network.name}) بنجاح.`, amount: -category.price });
